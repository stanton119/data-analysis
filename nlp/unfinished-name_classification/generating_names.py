...
Tutorial from: https://pytorch.org/tutorials/intermediate/char_rnn_generation_tutorial.html
Converting for PyTorch-Lightning.


Given a language, generate names.
Training data setup:
Take name: x
Each letter should predict the next
x[:-1] -> x[1:]

Sample the output probs to allow variety of names
"""
