...
class Model(torch.nn.Module):
    ...
    def forward(self, batch):
        ...
        # Continuous features
        if (
            hasattr(self, "user_continuous_proj")
            and "user_features" in batch
            and "continuous" in batch["user_features"]
        ):
        ...
        if (
            hasattr(self, "item_continuous_proj")
            and "item_features" in batch
            and "continuous" in batch["item_features"]
        ):
